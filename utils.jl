...
# p2 = heatmap(C[1,1:nGrid], C[1,1:nGrid], reshape(Array(exp.(phi((C),th0))), (nGrid, nGrid)));
# p3 = heatmap(C[1,1:nGrid], C[1,1:nGrid], reshape(r0, (nGrid, nGrid)) - reshape(Array(exp.(phi((C),th0))), (nGrid, nGrid)));
