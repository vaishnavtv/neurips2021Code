...
dx = [0.1f0; 0.1f0; 0.001f0]; # discretization size used for training
tEnd = 0.1f0; 
...
if runExp
    open(runExp_fileName, "a+") do io
        ...
        α_ic = $(α_ic). Using SE and dramatically large weight on IC. Using Gaussian at t0. Very small Q_fpke. Very small tEnd.
