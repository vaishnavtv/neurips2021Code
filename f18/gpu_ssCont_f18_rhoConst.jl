...
x1_min = 2f0*vN3(-100f0) ; x1_max = 2f0*vN3(100f0);
x2_min = 2f0*alpN3(deg2rad(-10f0)) ; x2_max = 2f0*alpN3(deg2rad(10f0))
x3_min = 2f0*thN3(deg2rad(-10f0)) ; x3_max = 2f0*thN3( deg2rad(10f0));
x4_min = 2f0*qN3(deg2rad(-5f0)) ; x4_max = 2f0*qN3(deg2rad(5f0)) 
