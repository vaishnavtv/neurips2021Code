...
using JLD2,PyPlot,NeuralPDE,ModelingToolkit,LinearAlgebra,Flux,Trapz,Printf,LaTeXStrings,ForwardDiff, Quadrature
pygui(true);
# @variables x1, x2
...
Q_fpke = 0.0f0*1.0I(4); # Q = σ^2

strat = "quasi_"
expNum = 1;
cd(@__DIR__);
fileLoc = "data_sym/f16Sym_$(strat)$(expNum).jld2";
