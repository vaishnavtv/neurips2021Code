...
#original trim values and control law
xbar = Float32.([
    0.0,
    0.0,
    10000.0,
...
Kc = Float32.([-0.5470758598111812 103.66925411758012 31.024026394129915 47.40198717690881; -0.03251963249654607 32.11378665734905 3.7426770697698895 14.969332380810693]);

## creating copies for mask
xbar2 = deepcopy(xbar); ubar2 = deepcopy(ubar);
xbar2[ind_x] .= 0f0; ubar2[ind_u] .= 0f0;
